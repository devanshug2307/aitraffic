...
```bash
codex mcp add aitraffic -- npx -y aitraffic mcp serve
claude mcp add --scope user aitraffic -- npx -y aitraffic mcp serve
```

Do not advertise these commands until the package is actually published.
